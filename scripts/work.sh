...
exec xfreerdp3 /cert:ignore /bpp:32 /network:broadband /audio-mode:0 /sound:sys:pulse /scale:140 /monitors:1 /floatbar:sticky:off /gfx:AVC444 /log-level:FATAL /timeout:30000 +f -themes -wallpaper -grab-keyboard \
/d:"${_domain}" \
/v:"${_host}" \
/u:"${_user}" \
/p:"${_password}"
